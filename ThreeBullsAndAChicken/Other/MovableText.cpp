...
void MovableText::setFontName(const String &fontName)
{
	...
	if (mFontName != fontName || mpMaterial.isNull() || !mpFont)
	{
		...
		FontPtr font = FontManager::getSingleton().getByName(mFontName);
		if (font.isNull())
			throw Exception(Exception::ERR_ITEM_NOT_FOUND, "FontManager.getByName(fontName) returns FontPtr.isNull()==true, FontName= " + fontName, "MovableText::setFontName");
		mpFont = static_cast<Font *> ( font.getPointer() );
