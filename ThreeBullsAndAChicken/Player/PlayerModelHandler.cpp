...
PlayerModelHandler::PlayerModelHandler(PolarCoordinates nwPos) : UniversalModelHandler(new PlayerRecipe(), nwPos),  m_isBlocking(false)
{
}
...
void PlayerModelHandler::init()
{
	...
	m_animations[ANIMATIONS::BLOCK] = static_cast<PlayerRecipe*>(m_crRecipe)->getBlock(m_entity);
}
