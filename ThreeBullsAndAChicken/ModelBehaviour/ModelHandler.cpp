...
{
	if(lerp(nextPosition, dt, ANIMATIONS::ATTACK, m_LERPPrecision+m_startAttackDistance, GlobalVariables::getSingleton().getLERPAnimAttackRatio()))
...
{
	if (lerp(nextPosition, dt, ANIMATIONS::WALK, m_LERPPrecision, GlobalVariables::getSingleton().getLERPAnimWalkRatio()))
		return LERP_STATE::LERP_WALK;
	return LERP_STATE::LERP_ATTACK;
}
