...
MutantModelHandler::MutantModelHandler(PolarCoordinates normalPos) :UniversalModelHandler(new MutantRecipe(), normalPos), m_marked(false), m_selected(false), m_numberText(nullptr)
{
	markSelected(false);
}
